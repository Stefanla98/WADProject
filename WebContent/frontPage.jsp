...
<body data-spy="scroll" data-target="#navbar" data-offset="120" >
    ...
    <div id="menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header visible-xs">
                ...
                <a class="navbar-brand" href="#"><h2>Burgerville</h2></a>
            </div><!-- navbar-header -->
    ...
    <div id="header">
        ...
        <div class="center text-center">
            <div class="banner">
                <h1 class="">Burgerville</h1>
            </div>
            <div class="subtitle"><h4>A FILS RESTAURANT</h4></div>
        </div>
    </div>
    <!-- /#header -->
    ...
    <div id="story" class="light-wrapper">
        ...
        <div class="container inner">
            ...
            <p class="lead main text-center">Making the best websites for food since Coronavirus</p>
            <div class="row text-center story">
                ...
                <div class="col-sm-4">
                    <div class="col-wrapper">
                        ...
                        <h3>Food Quality</h3>
                        <p>The best burgers in Bucuresti</p>
                    </div>
                </div>
            </div>
            <!-- /.services --> 
    ...
    <div id="food-menu" class="light-wrapper">
        ...
        <div class="container inner">
            ...
            <p class="lead main text-center">There is no better love than the love of food!</p>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="img-responsive img-thumbnail" src="img/dish/3.png" alt=""></a>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="img-responsive img-thumbnail" src="img/dish/2.png" alt=""></a>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="img-responsive img-thumbnail" src="img/dish/4.png" alt=""></a>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="img-responsive img-thumbnail" src="img/dish/1.png" alt=""></a>
                        
                        <div class="pricing-item-details">
                            
                            <h3><a href="#">Burger 4</a></h3>
    ...
    <div id="reservation" class="light-wrapper">
        ...
        <div class="container inner">
            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="form form-table" method="post" name="" action="ReservationController">
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <p>1234 Danielescu Street, Bucuresti, Romania</p>

                    <h3><i class="fa fa-mobile fa-fw"></i>Contacts</h3>
                    <p>Email: <a href="">stefan_danielescu@burgerville.com</a></p>
    ...
    <footer id="footer" class="dark-wrapper">
        ...
        <div class="container inner">
            <div class="row">
                <div class="col-sm-6">
                    &copy; Copyright BurgervilleFILS 2020
                </div>
                <div class="col-sm-6">
